...
$selectQuery = "SELECT * FROM admins WHERE id = '$adminId'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE admins SET first_name = '$firstName', last_name = '$lastName', email = '$email', phone_number = '$phoneNumber', date_of_birth = '$dateOfBirth', gender = '$gender' WHERE id = '$adminId'";

    if ($conn->query($updateQuery) === TRUE) {
        header("Location: edit_admin.php?admin_id=$adminId&success=1");
        exit();
    } else {
...
<body>
    ...
    <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
        <div class="success-message">Admin details updated successfully.</div>
    <?php endif; ?>
    ...
    <a href="manage_admin.php" class="back-button">Back to Manage Admin</a>
</body>
</html>
