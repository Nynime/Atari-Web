        ...
        echo "<!DOCTYPE html>
              ...
              <body>
                ...
                <div class='user-details'>
                    ...
                    <a href='edit_admin.php?admin_id=$adminId'>Edit</a>
                    <a href='delete_admin.php?admin_id=$adminId'>Delete</a>
                    <a href='logout.php' class='logout-link'>Logout</a>
                    <a href='A1-Dashboard-Admin.html' class='back-button'>Back to Dashboard</a>
                </div>
              </body>
              </html>";
    } else {
